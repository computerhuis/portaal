...
(
    ...
    CONSTRAINT proof_of_issues_fk_4 FOREIGN KEY (equipment_id) REFERENCES equipment (id) ON UPDATE RESTRICT ON DELETE CASCADE
) ENGINE = InnoDB
  CHARACTER SET 'utf8'
...
CREATE INDEX proof_of_issues_i_4 ON proof_of_issues (equipment_id);
